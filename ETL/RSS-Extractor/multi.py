...
from article_extraction import extract_feed, process_feed
...
if local:
    os.system("python3 C:/Users/Charl/Documents/Projects/TokenizedToast/ETL/Content-Transform/main.py")